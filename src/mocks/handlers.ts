...
const User = [
  ...
  { id: "hasuhwan", nickname: "하수환", image: "/hasuhwan.jpeg" },
  { id: "kim", nickname: "김예지", image: faker.image.avatar() },
];
...
export const handlers = [
  ...
  http.get("/api/trends", ({ request }) => {
    return HttpResponse.json([
      { tagId: 1, title: "김예지", count: 1264 },
      { tagId: 2, title: "기태리", count: 1264 },
      { tagId: 3, title: "기태율", count: 1264 },
      { tagId: 4, title: "박지수", count: 1264 },
      { tagId: 5, title: "김종태", count: 1264 },
      { tagId: 6, title: "주홍준", count: 1264 },
      { tagId: 7, title: "김송", count: 1264 },
      { tagId: 8, title: "이원영", count: 1264 },
      { tagId: 9, title: "구자민", count: 1264 },
    ]);
  }),
];
